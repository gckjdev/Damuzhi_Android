...
public class TravelUtil
{
	...
	/**
     * 获取表示当前定位PLACE的图标
     * @param categoryId 分类ID，如景点／酒店／...（待确定），参见App.proto // 1,2,3,4,5
     * @return
     */
...
public static ArrayList<Place> entertainmentComposite(int compositeType,ArrayList<Place> placeList,HashMap<String, Double> location)
{
    ...
    */
    ...
    /**  
            * @description   按评价由高到低排序
            * @version 1.0  
            * @author liuxiaokun  
            * @update 2012-5-11 下午4:26:24  
            */  
	...
	/**  
	        * @description   按价格由高到低排序
	        * @version 1.0  
	        * @author liuxiaokun  
	        * @update 2012-5-11 下午4:26:43  
	        */  
	...
	/**  
	        * @description   按距离由近到远排序
	        * @version 1.0  
	        * @author liuxiaokun  
	        * @update 2012-5-11 下午4:27:13  
	        */  
