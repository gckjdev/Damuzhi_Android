...
public class TravelTipsActivity extends MenuActivity implements PlaceActivity
{
	...
	protected void onResume()
	{
		...
		{			
			loadFlag = 1;
			showRoundProcessDialog(TravelTipsActivity.this, R.layout.loading_process_dialog_anim);
			Task hotelTask = new Task(Task.TRAVEL_TIPS,TravelTipsActivity.this);
