...
public class ShoppingDetailActivity extends TravelActivity
{
	private TextView shoppingDetailTitle;
	private TextView shoppingIntro;
	private TextView openingTime;
	private TextView parkingInfo;
	private TextView trafficInfo;
	private TextView shoppingTips;
	...
	private ViewPager shoppingImage;
	private Place place;
	...
	private void init()
	{
		...
		main = (ViewGroup) inflater.inflate(R.layout.shopping_detail, null);
		group = (ViewGroup) main.findViewById(R.id.shopping_images_group);
		shoppingImage = (ViewPager) main.findViewById(R.id.shopping_images);
		for (int i = 0; i < size; i++) {  
            imageView = new ImageView(ShoppingDetailActivity.this);  
		...
		PlaceImageAdapter shoppingAdapter = new PlaceImageAdapter(imageViewlist);
		setContentView(main);
		shoppingImage.setAdapter(shoppingAdapter);
		shoppingImage.setOnPageChangeListener(scenecyImageListener);
		
		shoppingDetailTitle = (TextView) findViewById(R.id.shopping_detail_title);
		shoppingIntro = (TextView) findViewById(R.id.shopping_intro);
		openingTime = (TextView) findViewById(R.id.opening_time);
		parkingInfo = (TextView) findViewById(R.id.parking_info);
		trafficInfo = (TextView) findViewById(R.id.traffic_info);
		shoppingTips = (TextView) findViewById(R.id.shopping_tips);
		phoneNum = (TextView) findViewById(R.id.phone_num);
		address = (TextView) findViewById(R.id.address);
		website = (TextView) findViewById(R.id.website);
		
		mapView1 = (ImageView) findViewById(R.id.item_map_view);
		mapView2 = (ImageView)findViewById(R.id.shopping_detail_map_nearby);
		...
		recommendImage1 = (ImageView) findViewById(R.id.shopping_detail_recommend_image1);
		recommendImage2 = (ImageView) findViewById(R.id.shopping_detail_recommend_image2);
		recommendImage3 = (ImageView) findViewById(R.id.shopping_detail_recommend_image3);
		shoppingDetailTitle.setText(place.getName());
		shoppingIntro.setText(place.getIntroduction());
		openingTime.setText(place.getOpenTime());
		parkingInfo.setText(place.getParkingGuide());
		trafficInfo.setText(place.getTransportation());		
		shoppingTips.setText(place.getTips());
	...
	private OnClickListener clickListener = new OnClickListener()
	{
		...
		public void onClick(View v)
		{
			...
			case R.id.item_map_view:
				...
				intent.setClass(ShoppingDetailActivity.this, CommendPlaceMap.class);
				startActivity(intent);
				break;
			case R.id.shopping_detail_map_nearby:	
				intent.setClass(ShoppingDetailActivity.this, CommendPlaceMap.class);
				startActivity(intent);
				break;
	...
	{
		AlertDialog phoneCall = new AlertDialog.Builder(ShoppingDetailActivity.this).create();
